        ...
        <div className="bg-background py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                    ...
                    <Card variant="bento" className="md:col-span-4 p-10 bg-primary-container/20 group hover:bg-primary-container/30 transition-all border-primary/10 overflow-hidden">
                    ...
                    <Card variant="bento" className="md:col-span-2 p-8 bg-secondary-container/20 group hover:bg-secondary-container/30 transition-all border-secondary/10">
                    ...
                    <Card variant="bento" className="md:col-span-2 p-8 bg-tertiary-container/30 group hover:bg-tertiary-container/40 transition-all border-tertiary/10">
                    ...
                    <Card variant="bento" className="md:col-span-4 p-1 relative overflow-hidden group border-outline-variant/30">
