...
// Simple mock translations until next-intl is fully integrated
const t = (key: string) => {
                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        <div className="flex items-center justify-between">
                            <h1 className="text-3xl font-bold text-on-surface">
                                {t('title')} <span className="text-lg font-normal text-on-surface-variant">({meta.total})</span>
                            </h1>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {clinics.map((clinic) => (
                                    <ClinicCard
                                        ...
                                        rating={clinic.averageRating || 0}
                                        reviewCount={clinic.reviews?.length || 0}
                                    />
                                ))}
                            </div>
                        )}
