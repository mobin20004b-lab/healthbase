...
import { PaginationSimple } from "@/web/components/ui/pagination-simple";
import type { ClinicWithDetails } from "@/lib/services/clinics";
import type { Clinic } from "@prisma/client";

interface SearchResultsProps {
    data: ClinicWithDetails[];
    meta: {
        page: number;
        limit: number;
        total: number;
...
export function SearchResults({ data, meta }: SearchResultsProps) {
