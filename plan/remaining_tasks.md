...
- [x] **CI/CD Pipeline:** Setup GitHub Actions for automated linting, type checking, and testing (`plan/devops.md`).
- [x] **NextAuth Integration:** Implement NextAuth for secrets management and role-based permissions (`plan/pr.md`).
